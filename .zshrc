...
plugins=(git debian autojump last-working-dir screen vi-mode wd history-substring-search dirhistory python)


# User configuration

export PATH="/usr/local/sbin:/usr/sbin:/sbin:/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games:/usr/lib/ccache"
